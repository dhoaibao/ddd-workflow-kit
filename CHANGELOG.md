...
- Contributor rule requiring `CHANGELOG.md` updates before any commit step, recording pending changes under `Unreleased`.
...
[Unreleased]: https://github.com/dhoaibao/ddd-workflow-kit/compare/v0.1.0...HEAD
