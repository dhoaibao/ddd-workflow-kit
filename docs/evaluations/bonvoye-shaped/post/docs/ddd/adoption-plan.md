# Storytelling characterization increment
...
- dependency: exact context and model revisions
- acceptance: all seven characterization cases match their exact Given/When/Then outputs
- containment: stop on any authority, oracle, or scope mismatch
- stop condition: stop before authorization on any authority, oracle, owner, or scope mismatch
